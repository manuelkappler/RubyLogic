class DeMorgan < Equivalence
  ...
  def apply
    ...
    negated_el2 = (inside.element2.is_a? CompositeSentence and inside.element1.connective.is_a? Not) ?  inside.element2.element1 : CompositeSentence.new(neg, inside.element2)
